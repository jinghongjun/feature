...
public class UIFeatureList extends BaseActivity {
    
    private static final String TAG = UIFeatureList.class.getSimpleName();

    @Override
    public int getCreateItemRes() {
        return R.xml.ui_main;
    }

    @Override
    public int getMenuRes() {
        return R.menu.ui_main;
    }
